...
//     ],
//     techStack: [
//       'React', 'Tailwind CSS', 'React Router', 'Node.js', 'Express.js', 'MongoDB', 'Firebase'
//     ],
//     links: { live: '#', clientRepo: '#', serverRepo: '#' },
//     challenges: [
//       'Implementing secure premium content gating without hampering UX',
//       'Real-time article updates for editors and readers',
//       'Role-based access control with Firebase Auth & custom claims'
//     ],
//     improvements: [
//       'Add comment and like system for articles',
//       'Integrate AI-based content recommendations',
//       'Migrate to Next.js for SSR/SSG and better SEO'
//     ],
//   },
//   {
//     id: 'villax',
...
//     image: projectii,
//     description:
//       'An online room booking and rental platform with role-based dashboards.',
//     features: [
...
//     ],
//     techStack: [
//       'Next.js', 'Redux', 'Zod', 'Mongoose', 'Tailwind CSS', 'Node.js', 'Express.js', 'MongoDB', 'Firebase'
//     ],
//     links: { live: '#', clientRepo: '#', serverRepo: '#' },
//     challenges: [
//       'Handling Stripe webhooks for payment confirmation reliably',
//       'Complex role-based UI and route guards',
//       'Optimizing search and filtering with MongoDB aggregations'
//     ],
//     improvements: [
//       'Add real-time chat between host and guest',
...
//     image: projectiii,
//     description:
//       'An online library management platform for tracking books and borrowing.',
//     features: [
...
//     ],
//     techStack: [
//       'Next.js', 'Tailwind CSS', 'Shadcn', 'Node.js', 'Express.js', 'MongoDB', 'Firebase'
//     ],
//     links: { live: '#', clientRepo: '#', serverRepo: '#' },
//     challenges: [
//       'Implementing real-time book availability across concurrent users',
//       'Fine-grained book search with multiple filters',
//       'Ensuring data consistency between borrow/return operations'
//     ],
//     improvements: [
//       'Introduce book reservation queue',
//       'Add barcode scanner for quick book management',
